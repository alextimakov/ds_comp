...
# TODO: tabs with navigation on top
...
people: list = ['Вася', 'Серёжа', 'Алина', 'Саша']

filter_name = 'Группа навыков'
                    ...
                    html.Div(
                        ...
                        children=[
                            dash_table.DataTable(
                                id='table-editable',
                                columns=(
                                    [{'id': column, 'name': column} for column in personal_competencies.columns]
                                ),
